...
featured: true
publication: "ICLR 2026, ICML 2025 Workshop on Exploration in AI Today **(Best Paper)**, ICML 2025 Workshop on Generative AI and Biology **(Spotlight)**, Molecular Machine Learning Conference 2025 **(Best Paper)**, Machine Learning in Computational Biology 2025
"
links:
  - icon_pack: fas
    icon: trophy
